...
<head>
    ...
    <title>@yield('title', 'IndiaUnity - Send Money Home with 0.5% Fees')</title>
    
    <!-- Meta Tags -->
    <meta name="description" content="@yield('description', 'Send money from Dubai to India instantly with just 0.5% fees. Trusted by thousands of Indians abroad. Fast, secure, and transparent remittance service.')">
    <meta name="keywords" content="@yield('keywords', 'money transfer, remittance, Dubai to India, 0.5% fees, fintech, IndiaUnity')">
    <meta name="author" content="IndiaUnity">
    
    <!-- Open Graph Tags -->
    <meta property="og:title" content="@yield('og_title', 'IndiaUnity - Send Money Home with 0.5% Fees')">
    <meta property="og:description" content="@yield('og_description', 'Send money from Dubai to India instantly with just 0.5% fees. Trusted by thousands of Indians abroad.')">
    ...
    <meta name="twitter:title" content="@yield('twitter_title', 'IndiaUnity - Send Money Home with 0.5% Fees')">
    <meta name="twitter:description" content="@yield('twitter_description', 'Send money from Dubai to India instantly with just 0.5% fees.')">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('images/logo.png') }}" alt="IndiaUnity Logo" class="navbar-logo" height="50">
            </a>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="text-muted mb-0">&copy; {{ date('Y') }} IndiaUnity. All rights reserved.</p>
                </div>
