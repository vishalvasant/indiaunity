<?php $__env->startSection('title', 'IndiaUnity - Innovative Fintech Solutions'); ?>
<?php $__env->startSection('description', 'IndiaUnity makes international money transfers simple, transparent, and lightning-fast. Send money from Dubai to India with the lowest fees in the market - just 0.5%.'); ?>
                ...
                <div class="mb-5" data-aos="fade-up" data-aos-delay="400">
                    <div class="row g-3">
                        <div class="col-4">
                            <div class="text-center p-3 rounded-3" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                                <div class="d-flex justify-content-center align-items-baseline mb-2">
                                    <span class="h3 text-white mb-0 counter" data-target="500">0</span>
                        ...
                        <div class="col-4">
                            <div class="text-center p-3 rounded-3" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                                <div class="d-flex justify-content-center align-items-baseline mb-2">
                                    <span class="h3 text-white mb-0 counter" data-target="99.9">0</span>
                        ...
                        <div class="col-4">
                            <div class="text-center p-3 rounded-3" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                                <div class="d-flex justify-content-center align-items-baseline mb-2">
                                    <span class="h3 text-white mb-0 counter" data-target="24">0</span>
    ...
    <div class="container position-relative" style="z-index: 10;">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-4">
                <div class="badge bg-primary bg-opacity-10 text-primary px-3 py-1 mb-2" data-aos="fade-up" style="border: 1px solid rgba(59,130,246,0.2);">
                    💎 Comparison
                </div>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 position-relative overflow-hidden" style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); box-shadow: 0 10px 30px rgba(29,78,216,0.25);">
                            <!-- Glow Effect -->
    ...
    <div class="container">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="50">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#3b82f6,#1d4ed8); color: #fff;">🇦🇪</div>
                        <div class="flex-grow-1">
                            <div class="office-country">UAE - Dubai</div>
                            <span class="office-status status-active">● Open</span>
                            <div class="mt-2 small">
                                ☎️ <a href="tel:+971501448327">+971 501 448 327</a><br>
                                ✉️ <a href="mailto:indiaunityceo@gmail.com">indiaunityceo@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="100">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#f59e0b,#d97706); color: #fff;">🇮🇳</div>
                        <div class="flex-grow-1">
                            <div class="office-country">India</div>
                            <span class="office-status status-active">● Open</span>
                            <div class="mt-2 small">
                                ☎️ <a href="tel:+918320241355">+91 832 024 1355</a><br>
                                ✉️ <a href="mailto:indiaunityceo@gmail.com">indiaunityceo@gmail.com</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="150">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#06b6d4,#0891b2); color: #fff;">🇬🇧</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="200">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#10b981,#059669); color: #fff;">🇺🇸</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="250">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#ef4444,#dc2626); color: #fff;">🇨🇦</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="300">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#8b5cf6,#7c3aed); color: #fff;">🇦🇺</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="350">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#16a34a,#15803d); color: #fff;">🇸🇦</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="400">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#dc2626,#991b1b); color: #fff;">🇸🇬</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="450">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#dc2626,#7c2d12); color: #fff;">🇲🇾</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="500">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#059669,#047857); color: #fff;">🇿🇦</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="550">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#0891b2,#0e7490); color: #fff;">🇳🇿</div>
                        <div class="flex-grow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="600">
                <div class="card office-card h-100 p-3 border-0 shadow-sm">
                    <div class="d-flex gap-2 align-items-start">
                        <div class="office-flag" style="background: linear-gradient(135deg,#7c3aed,#6d28d9); color: #fff;">🇶🇦</div>
                        <div class="flex-grow-1">
...
<section class="section">
    <div class="container">
        ...
        <div class="row">
            <?php $__currentLoopData = $featuredBlogs->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo e(($index + 1) * 100); ?>">
                <div class="card blog-card h-100">
                    ...
                    <div class="card-img-top d-flex align-items-center justify-content-center text-white" 
                        ...
                        <div class="text-center">
                            ...
                            <div class="fw-bold"><?php echo e($blog->title); ?></div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="mb-2">
                            <span class="badge-category"><?php echo e($blog->category->name); ?></span>
                            <small class="text-muted ms-2"><?php echo e($blog->formatted_published_date); ?></small>
                        </div>
                        <h5 class="card-title"><?php echo e($blog->title); ?></h5>
                        <p class="card-text text-muted flex-grow-1"><?php echo e($blog->excerpt); ?></p>
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                <i class="fas fa-clock me-1"></i><?php echo e($blog->read_time); ?> min read
                            </small>
                            <a href="<?php echo e(route('blogs.show', $blog)); ?>" class="btn btn-outline-primary btn-sm">
                                Read More
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vishal/Desktop/IndiaUnity/resources/views/home.blade.php ENDPATH**/ ?>